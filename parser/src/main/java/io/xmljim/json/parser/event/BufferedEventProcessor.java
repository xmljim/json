...
import io.xmljim.json.parser.util.ByteRange;
import io.xmljim.json.parser.util.ByteSequence;
import io.xmljim.json.parser.util.ResizableByteBuffer;
...
import static io.xmljim.json.parser.event.ActionConstants.*;
import static io.xmljim.json.parser.util.ByteConstants.*;
    ...
    private void handleContainer(byte byt) {
        ...
        if (inStringToken()) {
            ...
            switch (byt) {
                ...
                case END_ARRAY -> fireArrayEndEvent(lineNumber, column);
                ...
                case END_MAP -> fireMapEndEvent(lineNumber, column);
            }
